...
export const getAllBooks = async (search?: string) => {
  try {
    ...
    return {
      success: false, error: (e as Error).message || 'Error connecting to database'
    }
  }
}
...
export const checkBookExists = async (title: string) => {
  try {
    ...
    return {
      exists: false, error: e instanceof Error ? e.message : 'Error checking book exists'
    }
  }
}
...
export const createBook = async (data: CreateBook) => {
  try {
    ...
    return {
      success: false,
      error: (e as Error).message || 'Error creating a book',
    }
  }
}
...
export const getBookBySlug = async (slug: string) => {
  try {
    ...
    return {
      success: false, error: (e as Error).message || 'Error fetching book by slug'
    }
  }
}
...
export const saveBookSegments = async (bookId: string, clerkId: string, segments: TextSegment[]) => {
  try {
    ...
    return {
      success: false,
      error: (e as Error).message || 'Error saving book segments',
    }
  }
}
